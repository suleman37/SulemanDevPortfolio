          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>Throughout my web development career, I have been fortunate to work on a number of exciting and challenging projects, including [E-Commerce Websites, Bussiness Websites and System Management Softwares etc ]. These projects have allowed me to demonstrate my expertise in development technologies and have given me the opportunity to take on various roles. I am proud of the results I have achieved on these projects and am always looking for new opportunities to apply my skills and experience to make a positive impact.</p>
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  <Nav variant="pills" className="nav-pills mb-5 justify-content-center align-items-center" id="pills-tab">
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="second">Website Dev</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="third">Enterprise Web</Nav.Link>
                    </Nav.Item>
                  </Nav>
